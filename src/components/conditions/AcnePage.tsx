...
const acneTestimonials = [
  {
    ...
    location: "Mumbai",
    testimonial: "\"Acne had me feeling frustrated and self-conscious for years. Turns out, it wasn't just about creams—it was about what my body needed inside. This program helped balance things from within, and now my skin is clearer and I finally feel confident again.\"",
