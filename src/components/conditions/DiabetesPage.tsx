import headerImage from 'figma:asset/a67a79b926ff2595159881b5d9814e006a37f757.png';
...
const diabetesTestimonials = [
  {
    name: "Meera Chopra",
    title: "Banker",
    location: "Mumbai",
    testimonial: "\"I thought getting diabetes in my late 40s was normal—that feeling tired and taking meds for life was just how it goes. This program changed all of that. My sugars are now under control, the doctor stopped my meds, and I feel amazing. Honestly, I'm still surprised at how good things have turned around.\"",
    image: "https://images.unsplash.com/photo-1494790108755-2616b612b47c?w=400&h=400&fit=crop&crop=face"
  }
]

const diabetesStats = {
  prevalence: "77 million adults",
  prevalenceDesc: "in India affected",
  successRate: "89%",
  successDesc: "achieve reversal",
...
const commonSymptoms = [
  ...
  "Frequent infections and mood changes"
]
...
export function DiabetesPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="lg:hidden bg-white diabetes-mobile-hero">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center pt-8 pb-8">
            ...
            <h1 className="hero-subtitle-28pt text-gray-700 mb-8 sm:mb-10 max-w-3xl mx-auto px-2">
              Reversing diabetes through functional medicine and lifestyle transformation
            </h1>
            ...
            <div className="mb-8 sm:mb-10 max-w-2xl mx-auto">
              <p className="text-base sm:text-lg text-gray-700 italic leading-relaxed mb-4 sm:mb-5 px-4">
                {diabetesTestimonials[0].testimonial}
              </p>
              <div className="text-center">
                <p className="text-base sm:text-lg font-medium text-energy-blue">
                  {diabetesTestimonials[0].name}
                </p>
                <p className="text-sm sm:text-base text-gray-600">
                  {diabetesTestimonials[0].title}
                </p>
              </div>
            </div>
            ...
            <div className="mb-8 sm:mb-10 flex justify-center">
              <div className="relative max-w-[350px] w-full mx-auto">
                <img
                  src={headerImage}
                  alt="Confident professional celebrating their diabetes transformation"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-5 text-center lg:text-left mb-8 sm:mb-10 lg:mb-12 pt-8 sm:pt-10 lg:pt-12 pr-0 lg:pr-5 ml-0 lg:-ml-[110px]">
              <h2 className="wellness-heading-main text-black mb-3 sm:mb-4" style={{ lineHeight: '1.04' }}>
                The Real Way to Reverse Type 2 Diabetes: <span className="font-light energy-blue">Address the Root</span>
              </h2>
              <p className="wellness-content-text text-gray-700 text-center lg:text-justify" style={{ lineHeight: '1.7', letterSpacing: '0.01em' }}>
                Type 2 Diabetes is not merely a blood sugar disorder—it reflects deeper metabolic dysfunction. At The Zen Axis, we focus on reversing these drivers with precision and care, often leading to significant improvements in HbA1c, energy levels, and medication requirements, within a clinically observed range of 3 to 12 months, depending on the severity and commitment to the process.
              </p>
              
              {/* Diabetes Explained */}
              <div className="mt-6 sm:mt-8 lg:mt-10">
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-light text-black mb-3 sm:mb-4 text-center lg:text-left">
                  Our Approach: <span className="energy-blue font-light not-italic">How We Diagnose and Treat</span>
                </h3>
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex gap-3">
                    ...
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Improve insulin sensitivity through tailored nutrition and movement
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Address inflammation, gut and liver health, and metabolic load
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Support the nervous system to reduce stress-driven glucose spikes
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Taper medications gradually and safely when metabolic markers allow
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 text-center lg:text-left mb-8 sm:mb-10 lg:mb-12 pt-6 sm:pt-8 lg:pt-10 pr-0 lg:pr-5 ml-0 lg:-ml-[110px]">
              <div className="mb-8 sm:mb-10 lg:mb-12">
                ...
                <p className="text-sleek-sm text-gray-600 leading-tight px-2 sm:px-4 lg:px-0 text-center lg:text-justify">
                  Our comprehensive approach addresses the root causes of diabetes through evidence-based functional medicine, personalized treatment protocols, and holistic lifestyle interventions for lasting transformation.
                </p>
              </div>
      ...
      <section className="py-8 sm:py-10 lg:py-12 bg-black">
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-sm sm:text-base text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-2 sm:px-4 lg:px-0">
            Join thousands who have successfully reversed diabetes with our personalized approach to holistic wellness.
          </p>
