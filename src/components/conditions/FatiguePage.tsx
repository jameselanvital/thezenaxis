import headerImage from 'figma:asset/5aed285fddc9aaace7b3f4d1b9638ca52cbb84cc.png';
...
const fatigueTestimonials = [
  {
    name: "Payal Jain",
    title: "Teacher",
    location: "Delhi",
    testimonial: "\"After giving birth, I was constantly exhausted. I thought it was just part of being a new mom, but the fatigue never left. This program helped me get my energy back, and for the first time in a long while, I feel like myself again.\"",
    image: "https://images.unsplash.com/photo-1494790108755-2616b612b47c?w=400&h=400&fit=crop&crop=face"
  }
]

const fatigueStats = {
  prevalence: "76% of people",
  prevalenceDesc: "experience chronic fatigue",
  successRate: "87%",
  successDesc: "regain energy",
...
export function FatiguePage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center pt-8 pb-8">
            ...
            <h1 className="hero-subtitle-28pt text-gray-700 mb-8 sm:mb-10 max-w-3xl mx-auto px-2">
              Restoring energy and vitality through holistic wellness
            </h1>
            ...
            <div className="mb-10 sm:mb-12 max-w-2xl mx-auto">
              <p className="text-base sm:text-lg text-gray-700 italic leading-relaxed mb-4 sm:mb-5 px-4">
                {fatigueTestimonials[0].testimonial}
              </p>
              <div className="text-center">
                <p className="text-base sm:text-lg font-medium text-energy-blue">
                  {fatigueTestimonials[0].name}
                </p>
                <p className="text-sm sm:text-base text-gray-600">
                  {fatigueTestimonials[0].title}
                </p>
              </div>
            </div>
            ...
            <div className="mb-8 sm:mb-10 flex justify-center">
              <div className="relative max-w-[350px] w-full mx-auto">
                <img
                  src={headerImage}
                  alt="Mother and child embracing, representing renewed energy and family wellness"
      ...
      {/* Understanding Chronic Fatigue Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-7 flex flex-col items-center justify-center lg:justify-start mt-[150px] -ml-[30px]">
              ...
              <h2 className="wellness-heading-large text-black text-center lg:text-left px-4 lg:px-8" style={{ lineHeight: '1.04' }}>
                The Quiet Art of<br />
                <span className="energy-blue font-light not-italic">Healing Fatigue</span>
              </h2>
            </div>
            ...
            <div className="lg:col-span-5 text-center lg:text-left mb-8 sm:mb-10 lg:mb-12 pt-8 sm:pt-10 lg:pt-12 pr-0 lg:pr-5 ml-0 lg:-ml-[110px]">
              <h2 className="wellness-heading-main text-black mb-3 sm:mb-4" style={{ lineHeight: '1.04' }}>
                It's Not Just About Being <span className="font-light energy-blue">Tired</span>
              </h2>
              <p className="wellness-content-text text-gray-700 text-center lg:text-justify">
                Chronic fatigue is often more than just a lack of sleep—it's a sign of underlying dysfunction in the body's energy production pathways.
              </p>
              <p className="wellness-content-text text-gray-700 text-center lg:text-justify mt-4">
                At The Zen Axis, we take a comprehensive approach to chronic fatigue, targeting its root causes. Most clients report significant improvement in energy levels and overall vitality within 3 to 6 months.
              </p>
              
              {/* Fatigue Explained */}
              <div className="mt-6 sm:mt-8 lg:mt-10">
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-light text-black mb-3 sm:mb-4 text-center lg:text-left">
                  How We Treat Chronic Fatigue <span className="energy-blue font-light not-italic">Differently</span>
                </h3>
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex gap-3">
                    ...
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Support adrenal health and restore energy production pathways
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Address thyroid and hormone imbalances
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Reduce systemic inflammation and optimize immune function
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Develop a personalized nutrition and lifestyle plan to sustain energy
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 text-center lg:text-left mb-8 sm:mb-10 lg:mb-12 pt-6 sm:pt-8 lg:pt-10 pr-0 lg:pr-5 ml-0 lg:-ml-[110px]">
              <div className="mb-8 sm:mb-10 lg:mb-12">
                ...
                <p className="text-sleek-sm text-gray-600 leading-tight px-2 sm:px-4 lg:px-0 text-center lg:text-justify">
                  Our comprehensive approach addresses the root causes of chronic fatigue through evidence-based functional medicine, personalized treatment protocols, and holistic lifestyle interventions for lasting energy restoration.
                </p>
              </div>
      ...
      <section className="py-8 sm:py-10 lg:py-12 bg-black">
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-sm sm:text-base text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-2 sm:px-4 lg:px-0">
            Join thousands who have successfully overcome chronic fatigue with our personalized approach to holistic wellness.
          </p>
