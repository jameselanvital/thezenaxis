import womanImage from 'figma:asset/26a61992ad97d744e60fb5bdfb1aebe6af89e381.png';
...
const autoimmuneTestimonials = [
  {
    name: "Ayesha",
    title: "Tech Director",
    location: "",
    testimonial: "After a stressful incident, lupus flared up, leaving me exhausted and overwhelmed. This program helped me regain control of my health, and now I'm feeling stronger, more energetic, and ready to move forward.",
...
export function AutoimmunePage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center pt-8 pb-8">
            ...
            <h1 className="hero-subtitle-28pt text-gray-700 mb-8 sm:mb-10 max-w-3xl mx-auto px-2">
              Modulating autoimmune conditions through immune system balance and gut healing
            </h1>
            ...
            <div className="mb-10 sm:mb-12 max-w-2xl mx-auto">
              <p className="text-base sm:text-lg text-gray-700 italic leading-relaxed mb-4 sm:mb-5 px-4">
                "{autoimmuneTestimonials[0].testimonial}"
              </p>
              <div className="text-center">
                <p className="text-base sm:text-lg font-medium text-energy-blue">
                  {autoimmuneTestimonials[0].name}
                </p>
                <p className="text-sm sm:text-base text-gray-600">
                  {autoimmuneTestimonials[0].title}
                </p>
              </div>
            </div>
            ...
            <div className="mb-8 sm:mb-10 flex justify-center">
              <div className="relative max-w-[350px] w-full mx-auto">
                <img
                  src={womanImage}
                  alt="Confident professional woman representing autoimmune wellness"
            ...
            <div className="lg:col-span-7 order-1 lg:order-2 mb-4 lg:mb-0 lg:-mb-[100px]">
              <div className="relative max-w-md sm:max-w-lg lg:max-w-none mx-auto">
                <img
                  src={womanImage}
                  alt="Confident professional woman representing autoimmune wellness"
                  className="w-full h-auto max-h-[400px] sm:max-h-[450px] md:max-h-[500px] lg:max-h-[600px] object-contain mt-[88px]"
                />
              </div>
            </div>
          </div>
      ...
      {/* Understanding Autoimmune Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-7 flex flex-col items-center justify-center lg:justify-start mt-[150px] -ml-[30px]">
              ...
              <h2 className="wellness-heading-large text-black text-center lg:text-left px-4 lg:px-8" style={{ lineHeight: '1.04' }}>
                Autoimmune Relief,<br />
                <span className="energy-blue font-light not-italic">The Mindful Way</span>
              </h2>
            </div>
            ...
            <div className="lg:col-span-5 text-center lg:text-left mb-8 sm:mb-10 lg:mb-12 pt-8 sm:pt-10 lg:pt-12 pr-0 lg:pr-5 ml-0 lg:-ml-[110px]">
              <h2 className="wellness-heading-main text-black mb-3 sm:mb-4" style={{ lineHeight: '1.04' }}>
                It's Not Just Your <span className="font-light energy-blue">Immune System</span>
              </h2>
              <p className="wellness-content-text text-gray-700 text-center lg:text-justify" style={{ lineHeight: '1.7', letterSpacing: '0.01em' }}>
                Autoimmune conditions occur when the body's immune system mistakenly attacks its own tissues. Without addressing these root causes, autoimmune conditions can remain active and disrupt your quality of life.
              </p>
              <p className="wellness-content-text text-gray-700 text-center lg:text-justify mt-4" style={{ lineHeight: '1.7', letterSpacing: '0.01em' }}>
                At The Zen Axis, we focus on restoring immune balance and addressing underlying triggers. Most clients experience significant improvements in symptoms and overall health within 6 to 12 months.
              </p>
              
              {/* Autoimmune Explained */}
              <div className="mt-6 sm:mt-8 lg:mt-10">
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-light text-black mb-3 sm:mb-4 text-center lg:text-left">
                  Root-Cause Care, <span className="energy-blue font-light not-italic">Personalized for You</span>
                </h3>
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex gap-3">
                    ...
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Rebalance immune system function and reduce autoimmunity triggers
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Address gut health issues such as leaky gut and inflammation
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Regulate hormonal imbalances contributing to immune dysfunction
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Optimize nutrition to support immune function and reduce inflammation
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Develop stress management techniques to support long-term immune health
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 text-center lg:text-left mb-8 sm:mb-10 lg:mb-12 pt-6 sm:pt-8 lg:pt-10 pr-0 lg:pr-5 ml-0 lg:-ml-[110px]">
              <div className="mb-8 sm:mb-10 lg:mb-12">
                ...
                <p className="text-sleek-sm text-gray-600 leading-tight px-2 sm:px-4 lg:px-0 text-center lg:text-justify">
                  Our comprehensive approach addresses the root causes of autoimmune conditions through evidence-based functional medicine, personalized treatment protocols, and holistic lifestyle interventions for lasting immune balance.
                </p>
              </div>
      ...
      <section className="py-8 sm:py-10 lg:py-12 bg-black">
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-sm sm:text-base text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-2 sm:px-4 lg:px-0">
            Join thousands who have successfully managed their autoimmune conditions with our personalized approach to holistic wellness.
          </p>
