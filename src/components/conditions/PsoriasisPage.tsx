import womanImage from 'figma:asset/8e12ceaff08a03f4c8b746f505ac885cccc7db41.png';
...
const psoriasisTestimonials = [
  {
    name: "Deepthi",
    title: "Speech Therapist",
    location: "Bangalore",
    testimonial: "\"Psoriasis used to make me hide away. This program helped me find my triggers, and now my skin is calmer—and I feel confident being seen again.\"",
    image: "https://images.unsplash.com/photo-1494790108755-2616b612b47c?w=400&h=400&fit=crop&crop=face"
  }
]

const psoriasisStats = {
...
const commonSymptoms = [
  "Thick, raised, red patches covered with silvery scales",
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center pt-8 pb-8">
            ...
            <h1 className="hero-subtitle-28pt text-gray-700 mb-8 sm:mb-10 max-w-3xl mx-auto px-2">
              Clearing psoriasis through autoimmune healing and inflammation reduction
            </h1>
            ...
            <div className="mb-10 sm:mb-12 max-w-2xl mx-auto">
              <p className="text-base sm:text-lg text-gray-700 italic leading-relaxed mb-4 sm:mb-5 px-4">
                {psoriasisTestimonials[0].testimonial}
              </p>
              <div className="text-center">
                <p className="text-base sm:text-lg font-medium text-energy-blue">
                  {psoriasisTestimonials[0].name}
                </p>
                <p className="text-sm sm:text-base text-gray-600">
                  {psoriasisTestimonials[0].title}
                </p>
              </div>
            </div>
            ...
            <div className="mb-4 sm:mb-6 flex justify-center">
              <div className="relative obesity-mobile-clean-image-container">
                <img
                  src={womanImage}
                  alt="Happy woman celebrating her psoriasis healing transformation"
                  className="obesity-mobile-clean-image w-full h-auto object-contain translate-y-[22px]"
                />
              </div>
            </div>
            ...
            <div className="lg:col-span-7 order-1 lg:order-2 mb-4 lg:mb-0 lg:-mb-[100px]">
              <div className="relative max-w-md sm:max-w-lg lg:max-w-none mx-auto">
                <img
                  src={womanImage}
                  alt="Happy woman celebrating her psoriasis healing transformation"
                  className="w-full h-auto max-h-[400px] sm:max-h-[450px] md:max-h-[500px] lg:max-h-[600px] object-contain mt-[82px]"
                />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-7 flex flex-col items-center justify-center lg:justify-start mt-[150px] -ml-[30px]">
              ...
              <h2 className="wellness-heading-large text-black text-center lg:text-left px-4 lg:px-8" style={{ lineHeight: '1.04' }}>
                Inner Peace, Radiant<br />
                Skin— <span className="energy-blue font-light not-italic">The Zen Way</span>
              </h2>
            </div>
            ...
            <div className="lg:col-span-5 text-center lg:text-left mb-8 sm:mb-10 lg:mb-12 pt-8 sm:pt-10 lg:pt-12 pr-0 lg:pr-5 ml-0 lg:-ml-[110px]">
              <h2 className="wellness-heading-main text-black mb-3 sm:mb-4" style={{ lineHeight: '1.04' }}>
                Beyond the <span className="font-light energy-blue">Skin</span>
              </h2>
              <p className="wellness-content-text text-gray-700 text-center lg:text-justify">
                Psoriasis is more than a skin condition. It's a chronic autoimmune disorder where the immune system triggers rapid skin cell turnover. While topical treatments can soothe symptoms, lasting relief comes from addressing the root causes. Many clients begin to see improvements in 3 to 6 months. At The Zen Axis, we focus on calming the immune response and restoring balance within your body.
              </p>
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex gap-3">
                    ...
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Immune system modulation to reduce flare-ups and inflammation
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Gut health restoration to balance the microbiome and reduce systemic inflammation
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Anti-inflammatory nutrition tailored to support skin health
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Stress management techniques to reduce cortisol and its impact on psoriasis
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 text-center lg:text-left mb-8 sm:mb-10 lg:mb-12 pt-6 sm:pt-8 lg:pt-10 pr-0 lg:pr-5 ml-0 lg:-ml-[110px]">
              <div className="mb-8 sm:mb-10 lg:mb-12">
                ...
                <p className="text-sleek-sm text-gray-600 leading-tight px-2 sm:px-4 lg:px-0 text-center lg:text-justify">
                  Our comprehensive approach addresses the root causes of psoriasis through evidence-based functional medicine, immune system modulation, and holistic lifestyle interventions for lasting skin healing.
                </p>
              </div>
              ...
              <AccordionItem value="root-cause" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    We investigate the underlying autoimmune triggers and inflammatory factors contributing to your psoriasis through comprehensive testing and detailed analysis.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="natural-healing" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    Our approach emphasizes natural immune modulation, anti-inflammatory nutrition, and evidence-based supplementation to restore skin health and immune balance.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="personalized-care" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    Every treatment plan is uniquely designed for your specific psoriasis triggers, immune patterns, genetics, and lifestyle factors.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="mind-body" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    We address stress management and emotional well-being alongside physical symptoms, recognizing the strong mind-body connection in autoimmune conditions.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="lifestyle-medicine" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    Sustainable lifestyle modifications that support immune balance, reduce inflammation, and prevent psoriasis flare-ups long-term.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="ongoing-support" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    Continuous monitoring, protocol adjustments, and support throughout your healing journey to ensure lasting skin health and remission.
                  </p>
                </AccordionContent>
              </AccordionItem>
                </Accordion>
      ...
      <section className="py-8 sm:py-10 lg:py-12 bg-black">
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-sm sm:text-base text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-2 sm:px-4 lg:px-0">
            Join thousands who have successfully cleared their psoriasis with our personalized approach to holistic wellness.
          </p>
