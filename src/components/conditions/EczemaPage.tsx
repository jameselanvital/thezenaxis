import womanImage from 'figma:asset/c94eebfff7decab16d224976f931d1bb85ba4db0.png';
...
const eczemaTestimonials = [
  {
    name: "Vinitha",
    title: "Researcher",
    location: "",
    testimonial: "My eczema would flare up with stress or certain foods, and I never knew how to control it. This program helped me identify my triggers and calm the inflammation. Now my skin's clearer, and I feel more at ease—inside and out.",
    image: "https://images.unsplash.com/photo-1494790108755-2616b612b47c?w=400&h=400&fit=crop&crop=face"
  }
]

const eczemaStats = {
  prevalence: "31.6 million",
  prevalenceDesc: "people affected",
  successRate: "85%",
...
const commonSymptoms = [
  ...
  "Red, scaly patches that may weep",
...
const potentialComplications = [
  ...
  "Asthma and allergic rhinitis development"
]

export function EczemaPage() {
  return (
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="text-center pt-8 pb-8">
            ...
            <h1 className="hero-subtitle-28pt text-gray-700 mb-8 sm:mb-10 max-w-3xl mx-auto px-2">
              Healing eczema through immune modulation and barrier restoration
            </h1>
            ...
            <div className="mb-10 sm:mb-12 max-w-2xl mx-auto">
              <p className="text-base sm:text-lg text-gray-700 italic leading-relaxed mb-4 sm:mb-5 px-4">
                "{eczemaTestimonials[0].testimonial}"
              </p>
              <div className="text-center">
                <p className="text-base sm:text-lg font-medium text-energy-blue">
                  {eczemaTestimonials[0].name}
                </p>
                <p className="text-sm sm:text-base text-gray-600">
                  {eczemaTestimonials[0].title}
                </p>
              </div>
            </div>
            ...
            <div className="mb-4 sm:mb-6 flex justify-center">
              <div className="relative obesity-mobile-clean-image-container">
                <img
                  ...
                  className="obesity-mobile-clean-image w-full h-auto object-contain translate-y-[26px]"
                />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-7 flex flex-col items-center justify-center lg:justify-start mt-[150px] -ml-[30px]">
              ...
              <h2 className="wellness-heading-large text-black text-center lg:text-left px-4 lg:px-8" style={{ lineHeight: '1.04' }}>
                Healthy Skin, Peaceful<br />
                Mind <span className="energy-blue font-light not-italic">The Zen Way</span>
              </h2>
            </div>
            ...
            <div className="lg:col-span-5 text-center lg:text-left mb-8 sm:mb-10 lg:mb-12 pt-8 sm:pt-10 lg:pt-12 pr-0 lg:pr-5 ml-0 lg:-ml-[110px]">
              <h2 className="wellness-heading-main text-black mb-3 sm:mb-4" style={{ lineHeight: '1.04' }}>
                Soothing the Skin by <span className="font-light energy-blue">Healing Within</span>
              </h2>
              <p className="wellness-content-text text-gray-700 text-center lg:text-justify">
                Eczema isn't just dry skin. It's an autoimmune response that stems from inflammation, gut dysbiosis, and immune system dysfunction. While creams provide short-term relief, true healing requires addressing these underlying issues. Clients often start seeing improvements in 3 to 6 months.
              </p>
              <p className="wellness-content-text text-gray-700 text-center lg:text-justify mt-4">
                At The Zen Axis, we focus on restoring balance to your immune system and skin health from within.
              </p>
              
              {/* Our Signature Approach */}
              <div className="mt-6 sm:mt-8 lg:mt-10">
                <h3 className="text-xl sm:text-2xl lg:text-3xl font-light text-black mb-3 sm:mb-4 text-center lg:text-left">
                  Our Signature Approach to <span className="energy-blue font-light not-italic">Wellness</span>
                </h3>
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex gap-3">
                    ...
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Immune system support to reduce inflammation and flare-ups
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Gut health restoration to balance the microbiome and reduce triggers
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Anti-inflammatory nutrition & personalized skincare recommendation
                    </p>
                  </div>
                  ...
                  <div className="flex gap-3">
                    <div className="w-1.5 h-1.5 bg-black rounded-full flex-shrink-0 mt-[calc(0.4em+6px)]"></div>
                    <p className="wellness-content-text text-gray-600 text-center lg:text-left flex-1">
                      Stress reduction to minimize cortisol's impact on skin health
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-5 text-center lg:text-left mb-8 sm:mb-10 lg:mb-12 pt-6 sm:pt-8 lg:pt-10 pr-0 lg:pr-5 ml-0 lg:-ml-[110px]">
              <div className="mb-8 sm:mb-10 lg:mb-12">
                ...
                <p className="text-sleek-sm text-gray-600 leading-tight px-2 sm:px-4 lg:px-0 text-center lg:text-justify">
                  Our comprehensive approach addresses the root causes of eczema through evidence-based functional medicine, personalized treatment protocols, and holistic skin restoration for lasting healing.
                </p>
              </div>
              ...
              <AccordionItem value="root-cause" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    We investigate the underlying factors contributing to your eczema through comprehensive testing and detailed health history analysis.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="natural-healing" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    Our approach emphasizes natural healing methods, anti-inflammatory nutrition, and targeted supplementation to restore skin health.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="personalized-care" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    Every treatment plan is uniquely designed for your specific triggers, skin type, and individual healing needs.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="mind-body" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    We address the stress-skin connection and emotional aspects of eczema alongside physical symptoms for comprehensive healing.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="lifestyle-medicine" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    Sustainable lifestyle modifications that support long-term skin health and prevent eczema flare-ups.
                  </p>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="ongoing-support" className="border-0 border-b border-gray-100 last:border-b-0">
                ...
                <AccordionContent className="pt-0 pb-4 sm:pb-5 px-2 sm:px-0">
                  <p className="text-xs sm:text-sm text-gray-600 leading-tight tracking-wide opacity-90 text-center lg:text-justify">
                    Continuous monitoring, adjustments, and support throughout your healing journey to ensure lasting skin health.
                  </p>
                </AccordionContent>
              </AccordionItem>
                </Accordion>
      ...
      <section className="py-8 sm:py-10 lg:py-12 bg-black">
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-sm sm:text-base text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-2 sm:px-4 lg:px-0">
            Join thousands who have successfully healed their eczema with our personalized approach to holistic wellness.
          </p>
